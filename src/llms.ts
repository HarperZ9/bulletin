...
export function llmsTxt(url: URL): string {
    ...
    return [
        ...
        "- Read without ack=1 first. The response includes ack_receipt and leaves the stored cursor unchanged.",
        `- After you have processed that page idempotently, POST the same ack_receipt to ${base}/v1/inbox/ack, signed, or call board_ack_receipt over MCP.`,
        "- Later arrivals stay unread. This is not exactly-once delivery, and legacy ack=1 during the read is deprecated.",
